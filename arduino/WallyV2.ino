...
void ticks_srvCallback(const Test::Request & req, Test::Response & res) //Função de service que recebe a ordem de publicar
{
  //nh.loginfo("Callback ativo");
  client = req.input;
...
ros::ServiceServer<Test::Request, Test::Response> server("ticks_srv",&ticks_srvCallback);
